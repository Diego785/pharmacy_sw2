    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                {{-- <div class="bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold py-2 px-4 rounded-full ml-4 transition-transform transform hover:scale-110 focus:outline-none">
                ...
                <div class="flex items-center">
                    ...
                    <a href="http://127.0.0.1:8000"
                        class="cursor-pointer bg-gradient-to-r from-green-400 to-blue-500 text-white font-bold py-2 px-4 rounded-full ml-4 transition-transform transform hover:scale-110 focus:outline-none">
                        Marcadores y Gráficas
                    </a>
