    ...
    <div class="h-full flex flex-col bg-gray-100 dark:bg-gray-700 shadow-xl overflow-y-scroll">
        ...
        <div class="bg-green-300 shadow-lg pb-3 rounded-b-3xl">
            <div class="flex  rounded-b-3xl bg-gray-100 dark:bg-gray-700 space-y-5 flex-col items-center py-7">
                <img class="h-28 w-28 rounded-full" src="{{ asset('imgs/logo.PNG') }}" alt="User">
                <span class="text-h1">My Analysis Center</span>
                <span class="text-h5">Start up</span>
            </div>
            <div class="grid px-7 py-2  items-center justify-around grid-cols-3 gap-4 divide-x divide-solid ">
                <div class="col-span-1 flex flex-col items-center ">
                    ...
                    <span class="text-lg font-medium 0">Productos</span>
                </div>
                ...
                <div class="col-span-1 px-3 flex flex-col items-center ">
                    ...
                    <span class="text-lg font-medium">Total de Ventas Bs.</span>
                </div>
            </div>
                    ...
                    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                        <div class="max-w-xl mx-auto text-center">
                            <div class="inline-flex px-4 py-1.5 mx-auto rounded-full  ">
                                <p class="text-4xl font-semibold tracking-widest text-g uppercase">MENU:</p>
                            </div>
                            <p class="mt-4 text-base leading-relaxed text-gray-600 group-hover:text-white">Menú de
                                acceso público de My Analysis Center. Bienvenido a nuestro Start up...</p>
                        </div>
                        <div class="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
                            <a href="{{ route('inicio-show') }}"
                                ...
                                <div class="py-2 px-9 relative  ">
                                    ...
                                    <svg class="w-16 h-16 fill-gray-400 group-hover:fill-white"
                                        ...
                                        <path
                                            d="m16.962 5.841 3.582.717-.716-4.115zM12.172 2.443l-.716 4.115 3.582-.717z">
                                        </path>
                                        <path
                                    ...
                                    <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">Inicio
                                    </h3>
                                    <p class="mt-4 text-base text-gray-600 group-hover:text-white">Visita nuestra vista
                                        principal para conocer las novedades de nosotros.</p>
                                </div>
                            </a>
                            ...
                            <a href="{{ route('contact-show') }}"
                                ...
                                <div class="py-2 px-9 relative  ">
                                    <svg class="w-16 h-16 fill-gray-400 group-hover:fill-white"
                                        ...
                                        viewBox="0 0 64 64" id="furniture">
                                        <path
                                    ...
                                    <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">
                                        Contáctanos</h3>
                                    <p class="mt-4 text-base text-gray-600 group-hover:text-white">Conoce más sobre los
                                        integrantes de este proyecto.</p>
                                </div>
                            </a>

                            <a href="{{ route('preguntas-show') }}"
                                class="transition-all  duration-1000 bg-white hover:bg-blue-500  hover:shadow-xl m-2 p-4 relative z-40 group  ">
                                <div
                                    class=" absolute  bg-blue-500/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  ">
                                </div>
                                <div class="py-2 px-9 relative  ">
                                    ...
                                    <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">Preguntas
                                        Frecuentes</h3>
                                    <p class="mt-4 text-base text-gray-600 group-hover:text-white">Conoce las preguntas
                                        más frecuentes a nuestra empresa.</p>
                                </div>
                            </a>
                            <a href="{{ route('soporte-show') }}"
                                ...
                                <div class="py-2 px-9 relative  ">
                                    <svg class="w-16 h-16 fill-gray-400 group-hover:fill-white"
                                        xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 68 68"
                                        viewBox="0 0 68 68" id="backpack">
                                        <path
                                    ...
                                    <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">Soporte
                                    </h3>
                                    <p class="mt-4 text-base text-gray-600 group-hover:text-white">Recibe soporte de
                                        nuestros colaboradores.</p>
                                </div>
                            </a>

                            <a href="{{ route('menu-projects-show') }}"
                                class="transition-all duration-1000 bg-white hover:bg-blue-500  hover:shadow-xl m-2 p-4 relative z-40 group  ">
                                <div
                                    class=" absolute  bg-blue-500/50 top-0 left-0 w-24 h-1 z-30  transition-all duration-200   group-hover:bg-white group-hover:w-1/2  ">
                                </div>
                                <div class="py-2 px-9 relative  ">
                                    ...
                                    <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">Otros
                                        Proyectos</h3>
                                    <p class="mt-4 text-base text-gray-600 group-hover:text-white">Conoce algunos de
                                        los proyectos más grandes de nuestro start up.</p>
                                </div>
                            </a>
                            ...
                            <a href="{{ route('dashboard') }}"
                                ...
                                <div class="py-2 px-9 relative  ">
                                    ...
                                    <h3 class="mt-8 text-lg font-semibold text-black group-hover:text-white ">Sistema
                                        de Información con Predicciones</h3>
                                    <p class="mt-4 text-base text-gray-600 group-hover:text-white">Solo para
                                        administradores.</p>
                                </div>
                            </a>
